      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-6 md:mb-8 animate-fade-in-up">
          ...
          <p className={`text-xs md:text-sm max-w-2xl mx-auto ${
            ...
            Ráda sa pobavím o nových projektoch, kreatívnych myšlienkach 
            alebo príležitostiach byť súčasťou vašej vízie
          </p>
        </div>
        ...
        <footer className="mt-8 pt-6 border-t border-gray-200 text-center">
          <div className={`text-xs md:text-sm mb-2 ${
            ...
            © 2025 Vytvorila <span className="font-semibold">LuGo</span>
          </div>
